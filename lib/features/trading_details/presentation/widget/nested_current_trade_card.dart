...
class NestedCurrentTradeCard extends StatelessWidget {
  final NestedCurrentTrade trade;
  const NestedCurrentTradeCard({super.key, required this.trade});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDetailRow('Market price', '${trade.marketPrice} USDT'),
