    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //       Text('${item.pair} - ${item.leverage}', style: const TextStyle(fontWeight: FontWeight.bold)),
          //       const Spacer(),
          //       Text('+${item.roi.toStringAsFixed(2)}% ROI', style: const TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
          //     ],
          //   ),
          // ),
          SizedBox(height: 10),
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              if (hasAvatar) ...[
                const CircleAvatar(radius: 10, child: Icon(Icons.person, size: 12)), // Placeholder avatar
                const SizedBox(width: 8),
              ],
